...
const HTMLPostCompileController = require('./controllers/post-compile');
...
Handlebars.postCompile = (template, settings) => {

	const preCompileController = new HTMLPostCompileController(settings);

	return preCompileController.process(template);
};
