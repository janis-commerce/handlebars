...
const HTMLPreCompileController = require('./controllers/pre-compile-controller');
...
Handlebars.preCompile = async data => {

	const preCompileController = new HTMLPreCompileController(data);

	return preCompileController.process();
};
