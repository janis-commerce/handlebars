...
module.exports.set = (object, path, value) => {
	...
	if(typeof value === 'object' && 'root_modules' in value)
...
/**
    ...
    *   @returns If the condition is true return the content inside of block, otherwise return the content inside of block else
    */
module.exports.indexof = function(propertyOrValue, haystack, block) {
	...
	if(haystack instanceof Array)
		return haystack.map(item => '' + item).find(element => element === propertyOrValue) ? block.fn(this) : block.inverse(this);

	if(typeof haystack === 'object' && propertyOrValue in haystack)
		return block.fn(this);

	if(typeof haystack === 'string' || typeof haystack === 'number')
		return propertyOrValue === haystack.toString() ? block.fn(this) : block.inverse(this);
...
/**
    ...
    *   @param {string} index The zone => 'en-GB', 'en-US', ...
    *   @param {string} index The dateStyle => full, long, medium, short
    *   @param {string} index The timeStyle => full, long, medium, short
