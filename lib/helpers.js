 ...
 * @param {boolean} The format value
 ...
 */
module.exports.falseHelper = (...args) => args.slice(0, -1).every(item => !item);
 ...
 */
module.exports.trueHelper = (...args) => args.slice(0, -1).every(item => !!item);
